...
const MOCK_MOVIE_DETAIL = {
  ...
  synopsis: "Uma jornada épica através das galáxias em busca de um novo lar para a humanidade.",
  backdrop: "https://images.unsplash.com/photo-1618336753974-aae8e04506aa?w=1600",
  cast: [
    { name: "Felipe Andrade", role: "Comandante Silva", initials: "FA" },
    { name: "Camila Rocha", role: "Dra. Elena", initials: "CR" },
    { name: "Diego Martins", role: "Piloto Kael", initials: "DM" }
  ],
  stats: { watched: "1.2K", lists: "856", favorites: "543", comments: "188" },
  initialReviews: [
    { 
...
function DetalhesFilme() {
  ...
  const [reviews, setReviews] = useState(movie.initialReviews);
